...
filename_metabolic_model = ['Recon2.v04.mat']
model = load(fullfile('Data/exampleData',filename_metabolic_model))
...
differ_genes.gene = string(differ_genes.gene)
...
% 4.1 (2013): 1-11.
% 
% _2. _Valc醨cel, Luis V., et al. "rMTA: robust metabolic transformation 
